...
const Mn = u(
  ...
  ao = {
    class:
      "bg-gradient-to-tr from-gray-950 to-gray-900 rounded-md px-2 py-5 text-white flex flex-col items-center",
  },
  ro = ["src"],
  io = _({
    ...
    setup(e) {
      const t = h(null),
        ...
        o = () => {
          ...
          setTimeout(() => {
            (t.value = Math.ceil(Math.random() * 100)), (n.value = !1);
          }, l);
        };
      return (l, a) => {
        var r;
